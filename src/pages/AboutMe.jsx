...
const About = () => {
  return (
    <div>
      ...
      <p>
        At Your Restaurant Name, we take pride in our diverse menu that caters to various tastes and preferences. Whether youre a fan of traditional classics or
      </p>
    </div>
  );
};
